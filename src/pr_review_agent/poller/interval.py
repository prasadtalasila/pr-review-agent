...
Every 304 across all three endpoints holds the interval steady; any single
200 (something changed) snaps straight back to the minimum. Snapping to the
floor rather than easing down keeps detection latency low right when a
repository just became active, which is when it matters.
"""
